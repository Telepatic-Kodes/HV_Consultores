// Chilean regions and their comunas
// Source: División política-administrativa oficial de Chile (16 regiones)
...
export const REGIONES: Region[] = [
  ...
  },
  {
    value: 'ohiggins',
    label: "O'Higgins",
    comunas: ['Chimbarongo', 'Chépica', 'Codegua', 'Coinco', 'Coltauco', 'Doñihue', 'Graneros', 'La Estrella', 'Las Cabras', 'Litueche', 'Lolol', 'Machalí', 'Malloa', 'Marchigüe', 'Mostazal', 'Nancagua', 'Navidad', 'Olivar', 'Palmilla', 'Paredones', 'Peralillo', 'Peumo', 'Pichidegua', 'Pichilemu', 'Placilla', 'Pumanque', 'Quinta de Tilcoco', 'Rancagua', 'Rengo', 'Requínoa', 'San Fernando', 'San Vicente', 'Santa Cruz'],
  },
  {
    value: 'maule',
    label: 'Maule',
...
/** Get comunas for a given region value */
export function getComunasByRegion(regionValue: string): string[] {
